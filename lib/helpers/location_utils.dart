...
///b for bike, d for car (driving), r for bus
Future<void> openLocationDestinationUrl(double lat, double lng, DrivingMode mode) async {
  var modeStr = "";
  switch (mode) {
    ...
    case DrivingMode.carrier:
      modeStr = "d";
      break;
  }

  var url = "google.navigation:q=$lat,$lng&mode=$modeStr";
  launcher.launchUrl(Uri.parse(url), mode: launcher.LaunchMode.externalNonBrowserApplication);
}

enum DrivingMode { bus, car, bike, carrier }
